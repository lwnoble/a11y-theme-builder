      ...
      return (
          <div>
              ...
              <div className="section-demos" data-background={colorMode}>
                  <div className="demo-title subtitle-large">Text Colored (only on the default background)</div>
                  <TextColored className="top40 " />
                  <p></p>
                  <div className="demo-title subtitle-large">Text with Gradient Title  (only on the default background)</div>
                  <TextGradient className="top40 " />
                  <p></p>
                  <div className="demo-title subtitle-large">Text with Colored Drop Shadow Title</div>
