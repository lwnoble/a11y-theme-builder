        ...
        <div>
            ...
            <ExampleSection>
               <div>NOTE: Only use colored and gradient cards on the primary, alt, black or white backgrounds.</div>
                ...
                <div className="subtitle-large top40">Left Aligned with Two Buttons</div>
                <CardSample color={colorMode} title="Title"  data-background={colorMode}>
                    Lorem ipsum dolor sit amet, consectetur adipiscing elit,
                    sed do eiusmod tempor incididunt ut labore et dolore
                    magna aliqua
                </CardSample>
                <div className="subtitle-large top40">Left Aligned with one Button</div>
                <CardSample color={colorMode} title="Title"  data-background={colorMode} hideSecondary={true}>
                    Lorem ipsum dolor sit amet, consectetur adipiscing elit,
                    sed do eiusmod tempor incididunt ut labore et dolore
                    magna aliqua
                </CardSample>
                <div className="subtitle-large top40">Left Aligned with Hotlink</div>
                <CardSample color={colorMode} title="Title"  data-background={colorMode} hotlink={true}>
                    Lorem ipsum dolor sit amet, consectetur adipiscing elit,
                    sed do eiusmod tempor incididunt ut labore et dolore
                    magna aliqua
                </CardSample>
                <div className="subtitle-large top40">Left Aligned, Clickable</div>
                ...
                <div className="subtitle-large top40">Center Aligned with Icon and Two Buttons</div>
                <CardSample color={colorMode}  title="Title" icon={ true } className={"centerAligned " + colorMode} >
                    Lorem ipsum dolor sit amet, consectetur adipiscing elit,
                    sed do eiusmod tempor incididunt ut labore et dolore
                    magna aliqua
                </CardSample>
                <div className="subtitle-large top40">Center Aligned with Icon and one Buttons</div>
                <CardSample color={colorMode} title="Title" icon={ true } className={"centerAligned " + colorMode} hideSecondary={true} hotlink={true}>
                    Lorem ipsum dolor sit amet, consectetur adipiscing elit,
                    sed do eiusmod tempor incididunt ut labore et dolore
                    magna aliqua
                </CardSample>
                <div className="subtitle-large top40">Center Aligned with Icon and Hotlink</div>
