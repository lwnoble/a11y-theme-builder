                ...
                <ExampleSection>
                  <Grid container spacing={2} columns={12} margin={2}>
                    <Grid lg={6} md={8} sm={12}>
                      <div className="subtitle-large top40">Inverted Bevel 1</div>
                      <div className="gradient-group top16">
                          <div className="card primary bevel-1-inverse" ></div>
                      </div>
                      <div className="subtitle-large top40">Inverted Bevel 2</div>
                      <div className="gradient-group top16">
                          <div className="card primary  bevel-2-inverse" ></div>
                      </div>
                      <div className="subtitle-large top40">Inverted Bevel 3</div>
                      <div className="gradient-group top16">
                          <div className="card primary  bevel-3-inverse" ></div>
                      </div>
                      <div className="subtitle-large top40">Inverted Bevel 4</div>
                      <div className="gradient-group top16">
                          <div className="card primary  bevel-4-inverse" ></div>
                      </div>
                      <div className="subtitle-large top40">Inverted Bevel 5</div>
                      <div className="gradient-group top16">
                          <div className="card primary  bevel-5-inverse" ></div>
                      </div>
                      <div className="subtitle-large top40">Inverted Bevel 6</div>
                      <div className="gradient-group top16">
                          <div className="card primary  bevel-6-inverse" ></div>
                      </div>
                      <div className="subtitle-large top40">Inverted Bevel 7</div>
                      <div className="gradient-group top16">
                          <div className="card primary  bevel-7-inverse" ></div>
                      </div>
                      <div className="subtitle-large top40">Inverted Bevel 8</div>
                      <div className="gradient-group top16">
                          <div className="card primary  bevel-8-inverse" ></div>
                      </div>
                      <div className="subtitle-large top40">Inverted Bevel 9</div>
                      <div className="gradient-group top16">
