                ...
                <ExampleSection>
                  <Grid container spacing={2} columns={12} margin={2}>
                    <Grid lg={6} md={8} sm={12}>
                      <div className="subtitle-large top40">Bevel 1</div>
                      <div className="gradient-group top16">
                          <div className="card primary bevel-1" ></div>
                      </div>
                      <div className="subtitle-large top40">Bevel 2</div>
                      <div className="gradient-group top16">
                          <div className="card primary  bevel-2" ></div>
                      </div>
                      <div className="subtitle-large top40">Bevel 3</div>
                      <div className="gradient-group top16">
                          <div className="card primary  bevel-3" ></div>
                      </div>
                      <div className="subtitle-large top40">Bevel 4</div>
                      <div className="gradient-group top16">
                          <div className="card primary  bevel-4" ></div>
                      </div>
                      <div className="subtitle-large top40">Bevel 5</div>
                      <div className="gradient-group top16">
                          <div className="card primary  bevel-5" ></div>
                      </div>
                      <div className="subtitle-large top40">Bevel 6</div>
                      <div className="gradient-group top16">
                          <div className="card primary  bevel-6" ></div>
                      </div>
                      <div className="subtitle-large top40">Bevel 7</div>
                      <div className="gradient-group top16">
                          <div className="card primary  bevel-7" ></div>
                      </div>
                      <div className="subtitle-large top40">Bevel 8</div>
                      <div className="gradient-group top16">
                          <div className="card primary  bevel-8" ></div>
                      </div>
                      <div className="subtitle-large top40">Bevel 9</div>
                      <div className="gradient-group top16">
