...
export const DoughnutChartMolecule: React.FC<Props> = ({ designSystem }) => {
    ...
    return (
        <div>
            <HeadingSection title="Apply Styles" heading="Doughnut Chart">
                <p>Configure settings that affect the appearance of doughnut charts.</p>
            </HeadingSection>
            <ExampleSection>
                <div className="row">
